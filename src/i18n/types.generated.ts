...
/**
 * kanban namespace의 번역 키 (76개)
 * 파일: locales/{lang}/kanban.json
 */
export type KanbanKeys =
  | 'kanban.add'
  | 'kanban.addColumn'
  | 'kanban.addDescription'
  | 'kanban.addProject'
  | 'kanban.addProjects'
  | 'kanban.allProjects'
  | 'kanban.alsoOnBoard'
  ...
  | 'kanban.membership'
  | 'kanban.memberships'
  | 'kanban.membershipsDescription'
  | 'kanban.moveColumnLeft'
  | 'kanban.moveColumnRight'
  | 'kanban.moveDown'
  | 'kanban.moveProject'
  | 'kanban.moveProjectsTo'
  | 'kanban.moveUp'
  | 'kanban.name'
  | 'kanban.nameHint'
  | 'kanban.noBoards'
  | 'kanban.noProjects'
  | 'kanban.offlineEmpty'
  | 'kanban.offlineHistory'
  | 'kanban.openBoard'
  | 'kanban.projectActions'
  | 'kanban.projectCount'
  | 'kanban.projectCount_one'
  | 'kanban.projectCount_other'
  | 'kanban.projectDescription'
  | 'kanban.projectDetails'
  | 'kanban.projectNotFound'
  | 'kanban.reload'
  | 'kanban.removeProject'
  | 'kanban.renameBoard'
  | 'kanban.renameColumn'
  | 'kanban.save'
  | 'kanban.saveError'
  | 'kanban.saving'
  | 'kanban.searchProjects'
  | 'kanban.sessionCount'
  | 'kanban.sessionCount_one'
  | 'kanban.sessionCount_other'
  | 'kanban.sessions'
  | 'kanban.sessionsHint'
  | 'kanban.statusOnBoard'
  | 'kanban.title'
  | 'kanban.todo'
  | 'kanban.unassigned'
  | 'kanban.unavailableDescription'
  | 'kanban.unavailableProject';
